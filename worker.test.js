...
describe('worker deployment config', () => {
  it('binds static assets using the Worker binding name', () => {
...
describe('worker book metadata helpers', () => {
  ...
  it('adds baseline security headers to frontend responses', async () => {
    ...
    expect(csp).toContain("connect-src 'self' https://api.quaduni.com https://media.quaduni.com https://cdn.jsdelivr.net blob:");
    expect(csp).toContain("font-src 'self' https://fonts.gstatic.com https://cdn.jsdelivr.net data:");
    expect(csp).toContain("img-src 'self' https://api.quaduni.com https://media.quaduni.com https://quaduni.com data: blob:");
    expect(csp).toContain("media-src 'self' https://api.quaduni.com https://media.quaduni.com blob:");
