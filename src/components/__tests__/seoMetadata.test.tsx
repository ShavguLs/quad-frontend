...
const getJsonLdScripts = (): Record<string, unknown>[] => Array.from(document.head.querySelectorAll('script[type="application/ld+json"]'))
...
describe('SEO metadata', () => {
  ...
  it('normalizes book schema price and includes breadcrumbs', async () => {
    renderWithHelmet(
      <BookPage
    ...
    await waitFor(() => {
      const [bookJsonLd, breadcrumbJsonLd] = getJsonLdScripts();
