            ...
            <PolicySection id="avtoroba" number="04" icon={<BookOpen className="w-4 h-4" />} title="ავტორის პირობები">
              <div>
                ...
                <div className="flex gap-4 mt-2">
                  <SplitStat label="ავტორი" value="60%" accent />
                  <SplitStat label="პლატფორმა" value="40%" />
                </div>
                <Body>
                  <span className="block mt-4">
                    თითოეული გაყიდული ეგზემპლარიდან ავტორი იღებს თანხის 60%-ს, ხოლო
                    პლატფორმის საკომისიო შეადგენს 40%-ს — ეს მოიცავს გადახდის დამუშავებას,
